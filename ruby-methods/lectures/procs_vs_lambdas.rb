...
# without a retur, it will act as a refulare code block that is yielded
...
#3. Proc returns from its own return and down not care about the rest of the code of the method that called it 
