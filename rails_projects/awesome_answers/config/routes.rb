Rails.application.routes.draw do
  ...
  #note that :provider is dynamic, which will be replaced with the provider used to sign in, so this
  #route could be used for multiple third party sign in s with omniauth
