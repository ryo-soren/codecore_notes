...
fs.readFile("/Users/ryosorensen/code-core/js-promises/lectures/files-to-read/file1.txt", "utf8", (err, data) => {
  if (err) {
    console.log(err);
  } else {
    console.log(data);
...
fs.readFile("/Users/ryosorensen/code-core/js-promises/lectures/files-to-read/file2.txt", "utf8", (err, data) => {
  if (err) {
    console.log(err);
  } else {
    console.log(data);
...
fs.readFile("/Users/ryosorensen/code-core/js-promises/lectures/files-to-read/file3.txt", "utf8", (err, data) => {
  if (err) {
    console.log(err);
  } else {
    console.log(data);
